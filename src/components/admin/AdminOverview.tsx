    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-slate-400 font-medium">Live Supabase Database Counts</span>
        </div>
          ...
          {statCards.map((card) => {
            ...
            return (
              <div
                ...
                className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer group relative overflow-hidden"
              >
                <div className="flex items-center justify-between mb-2">
                  <div className={`w-8 h-8 rounded-xl ${card.bg} flex items-center justify-center ${card.color} group-hover:scale-105 transition-transform`}>
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400 hidden sm:inline">Instant Publishing Shortcuts</span>
        </div>

        {/* 4 Prominent Actions Requested: Add Notice, Upload Material, Add Deadline, Add Exam */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
          <button
            onClick={() => onOpenQuickAction('notice')}
            className="p-4 rounded-2xl border border-amber-200/90 bg-gradient-to-br from-amber-50/80 to-amber-100/30 hover:bg-amber-100/70 hover:shadow-md hover:border-amber-400 transition-all flex items-center gap-3.5 text-left group"
          >
            <div className="w-11 h-11 rounded-xl bg-amber-500 text-white flex items-center justify-center font-bold shadow-xs group-hover:scale-105 transition-transform shrink-0">
              <Plus className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <span className="text-sm font-bold text-slate-900 block truncate group-hover:text-amber-900">
                + Add Notice
              </span>
              <span className="text-[11px] text-amber-800/80 font-medium truncate block">
          ...
          <button
            onClick={() => onOpenQuickAction('material')}
            className="p-4 rounded-2xl border border-emerald-200/90 bg-gradient-to-br from-emerald-50/80 to-emerald-100/30 hover:bg-emerald-100/70 hover:shadow-md hover:border-emerald-400 transition-all flex items-center gap-3.5 text-left group"
          >
            <div className="w-11 h-11 rounded-xl bg-emerald-600 text-white flex items-center justify-center font-bold shadow-xs group-hover:scale-105 transition-transform shrink-0">
              <Plus className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <span className="text-sm font-bold text-slate-900 block truncate group-hover:text-emerald-900">
                + Upload Material
              </span>
              <span className="text-[11px] text-emerald-800/80 font-medium truncate block">
                Slides, notes & files
              </span>
            </div>
          </button>
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-rose-200/90 bg-gradient-to-br from-rose-50/80 to-rose-100/30 hover:bg-rose-100/70 hover:shadow-md hover:border-rose-400 transition-all flex items-center gap-3.5 text-left group"
          >
            <div className="w-11 h-11 rounded-xl bg-rose-600 text-white flex items-center justify-center font-bold shadow-xs group-hover:scale-105 transition-transform shrink-0">
              <Plus className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <span className="text-sm font-bold text-slate-900 block truncate group-hover:text-rose-900">
                + Add Deadline
              </span>
              <span className="text-[11px] text-rose-800/80 font-medium truncate block">
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-purple-200/90 bg-gradient-to-br from-purple-50/80 to-purple-100/30 hover:bg-purple-100/70 hover:shadow-md hover:border-purple-400 transition-all flex items-center gap-3.5 text-left group"
          >
            <div className="w-11 h-11 rounded-xl bg-purple-600 text-white flex items-center justify-center font-bold shadow-xs group-hover:scale-105 transition-transform shrink-0">
              <Plus className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <span className="text-sm font-bold text-slate-900 block truncate group-hover:text-purple-900">
                + Add Exam
              </span>
              <span className="text-[11px] text-purple-800/80 font-medium truncate block">
                Quiz, midterm & final
              </span>
            </div>
          </button>
        ...
        <div className="pt-2 flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-slate-50 hover:bg-indigo-50 hover:text-indigo-600 text-slate-700 text-xs font-semibold border border-slate-200 hover:border-indigo-200 transition-all flex items-center gap-2"
          >
