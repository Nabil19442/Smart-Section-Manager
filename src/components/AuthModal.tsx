            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. 42"
                    className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 font-mono font-bold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="w-full px-3 py-2 bg-slate-100 border border-slate-200 rounded-lg text-xs text-indigo-900 font-bold flex items-center justify-between">
                    <span>Section E</span>
                    <span className="text-[10px] uppercase font-semibold text-slate-400">Locked</span>
                  </div>
                </div>
              </div>
            </>
